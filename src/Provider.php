...
namespace Spinzar\Setting;

use Spinzar\Setting\Middleware\AutoSaveSetting;
use Blade;
...
class Provider extends ServiceProvider
{
    ...
    public function boot()
    {
        $this->publishes([
            ...
            __DIR__ . '/Migrations/2020_11_01_000000_create_settings_table.php' => database_path('migrations/2020_11_01_000000_create_settings_table.php'),
        ], 'setting');
